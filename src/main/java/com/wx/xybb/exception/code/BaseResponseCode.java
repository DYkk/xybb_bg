package com.wx.xybb.exception.code;
...
public enum BaseResponseCode implements ResponseCodeInterface{
    ...
    OPERATION_ERROR(4000005,"操作失败,请重试"),
    ...
    OPENID_ERROR(4000017,"获取openid失败，请重新登录"),
    SCHOOL_ERROR(4000018,"教务系统可能崩溃了，请稍后再试"),
    TOKEN_IS_EXPIRED(4010001,"身份过期，请重新登录"),
    NO_COURSE(40000018,"未获取到课表"),
    NO_SCORE(4000019,"未获取到成绩"),
    NO_JIDIAN(4000020,"未获取到绩点"),
    JIDIAN_TO_SCORE(4000021,"请同学先更新成绩"),
    NO_EXAM(40000022,"未获取到考试安排"),
    NO_CET(4000023,"您没有预存哦")
    ;
